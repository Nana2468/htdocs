...
<body>
	...
	<div class="container mt-2">
		...
		<?php
		$no=0;
		$query = mysqli_query($connect, "SELECT id_report, username, title, content, date from report");
		...
		?>
			<div class="row">
				<div class="col">
					<div class="card">
						<div class="card-header d-flex justify-content-end rounded-top"> <a href="detail-report-operator.php?id_report=<?= $data["id_report"]; ?>"><i class="bi bi-info-circle-fill"></i></a></div>
