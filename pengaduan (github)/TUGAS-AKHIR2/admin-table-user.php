	...
	<div class="container my-5">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						<h5 class="modal-title mb-4" id="exampleModalLabel">Add Data User</h5>
						<form action="crudUser.php?Action=add-user" method="post">
							<div class="mb-3">
		...
		<div class="card shadow">
			<div class="card-header d-flex justify-content-between rounded-top">
				...
				<a data-bs-target="#addUser" data-bs-toggle="modal" class="btn btn-color rounded-5">Add</a>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-hover table-bordered" id="datatableUser" width="100%" cellspacing="0">
						<thead>
							<tr>
								<th>#</th>
								<th>ID User</th>
						...
						<tbody>
							<?php
							$no = 0;
							$query = mysqli_query($connect, "SELECT * from user WHERE level='public'");
							...
							?>
									...
									<td>
										<div class="dropdown">
											...
											<ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
												<li>
													<a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editUser<?= $no; ?>"><i class="bi bi-pencil-square me-1"></i>Edit</a>
												</li>
												<li>
													<a class="dropdown-item" type="button" href="crudUser.php?Action=delete-user&id_user=<?= $data["id_user"]; ?>"><i class="bi bi-trash2 me-1"></i>Hapus</a>
												</li>
								...
								<div class="modal fade" id="editUser<?= $no; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-body">
												<h5 class="modal-title mb-4" id="exampleModalLabel">Edit Data User</h5>
												<form action="crudUser.php?Action=edit-user" method="post">
													<input type="hidden" class="form-control" id="id_user" placeholder="16 digits" name="id_user" value="<?= $data["id_user"]; ?> " />

													<div class="mb-3">
														<label class="mb-2" for="nik">NIK</label>
														<input type="text" class="form-control" value="<?= $data["nik"]; ?>" id="nik" placeholder="16 digits" name="nik" width="50px" />
													</div>
													<div class="mb-3">
														<label class="mb-2" for="nik">NIP</label>
													...
													<div class="mb-3">
														<label class="mb-2" for="username">Username</label>
														<input type="text" value="<?= $data["username"]; ?>" class="form-control" id="username" placeholder="16 digits" name="username" />
													</div>
													<div class=" mb-3">
														<input type="hidden" class="form-control" id="level" placeholder="level" name="level" value="public" />
													</div>
