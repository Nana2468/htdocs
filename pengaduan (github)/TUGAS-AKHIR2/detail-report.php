			...
			<div class="col-8">
				<div class="card">
					<div class="card-body container">
						<h5 class="mb-4">Hi, <?= $_SESSION['username']; ?></h5>
						<h6><?= $data->$title ?></h6>
						<p><?= $data->$content ?></p>
						<div class="pb-4">
						...
						<a href="" class="pe-5 link-dark"><i class="pe-2 bi bi-pencil-fill"></i>Edit Report</a>
						<a href="" class="link-dark"><i class="pe-2 bi bi-trash3-fill"></i>Delete Report</a>
					</div>
